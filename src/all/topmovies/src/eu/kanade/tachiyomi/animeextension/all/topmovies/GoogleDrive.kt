...
class GoogleDrive : ConfigurableAnimeSource, AnimeHttpSource() {
    ...
    override val name = "topmovies"

    override val id = 4222017068256633289

    override var baseUrl = "https://topmovies.icu"
    ...
    private val getHeaders = headers.newBuilder().apply {
        ...
        add("Cookie", getCookie("https://topmovies.icu"))
        add("Host", "topmovies.icu")
    }.build()
    ...
    override suspend fun getAnimeDetails(anime: SAnime): SAnime {
        ...
        coverResponse.items?.firstOrNull()?.let {
            anime.thumbnail_url = "https://topmovies.icu/uc?id=${it.id}"
        }
